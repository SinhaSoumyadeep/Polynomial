...
/**
 * This class is an implementation of the empty node.
 */
public class EmptyNode implements PolynomialNode {
   ...
   *
   * @return the empty node in string format.
   */
  @Override
   ...
   * @return the reduced value is returned as a double here it is 0.0.
   */
  @Override
